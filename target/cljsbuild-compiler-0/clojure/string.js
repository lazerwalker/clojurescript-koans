...
{var pred__17210 = cljs.core._EQ_;var expr__17211 = limit;if(pred__17210.call(null,1,expr__17211))
...
{var ch = s.charAt(index);var temp__4090__auto___17217 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___17217))
{var replacement_17218 = temp__4090__auto___17217;buffer.append([cljs.core.str(replacement_17218)].join(''));
} else
{buffer.append(ch);
}
{
