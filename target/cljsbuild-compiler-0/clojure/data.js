...
{return cljs.core.reduce.call(null,(function (result,p__18038){var vec__18039 = p__18038;var k = cljs.core.nth.call(null,vec__18039,0,null);var v = cljs.core.nth.call(null,vec__18039,1,null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__18041 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__18041,0,null);var b_STAR_ = cljs.core.nth.call(null,vec__18041,1,null);var ab = cljs.core.nth.call(null,vec__18041,2,null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return cljs.core.PersistentVector.fromArray([(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true):null),((same)?cljs.core.PersistentArrayMap.fromArray([k,ab], true):null)], true);
});
/**
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__18042 = x;if(G__18042)
{var bit__3746__auto__ = (G__18042.cljs$lang$protocol_mask$partition0$ & 1024);if((bit__3746__auto__) || (G__18042.cljs$core$IMap$))
{return true;
} else
...
{var bit__3746__auto__ = (G__18043.cljs$lang$protocol_mask$partition0$ & 4096);if((bit__3746__auto__) || (G__18043.cljs$core$ISet$))
{return true;
} else
...
{if((function (){var G__18044 = x;if(G__18044)
{var bit__3746__auto__ = (G__18044.cljs$lang$protocol_mask$partition0$ & 16777216);if((bit__3746__auto__) || (G__18044.cljs$core$ISequential$))
{return true;
} else
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__18045 = clojure.data.equality_partition.call(null,a);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"map","map",1014012110),G__18045))
