...
cljs.reader.read_char = (function read_char(reader){if((function (){var and__3119__auto__ = reader;if(and__3119__auto__)
...
{var x__3723__auto__ = (((reader == null))?null:reader);return (function (){var or__3128__auto__ = (cljs.reader.read_char[goog.typeOf(x__3723__auto__)]);if(or__3128__auto__)
{return or__3128__auto__;
} else
{var or__3128__auto____$1 = (cljs.reader.read_char["_"]);if(or__3128__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__3119__auto__ = reader;if(and__3119__auto__)
...
{var x__3723__auto__ = (((reader == null))?null:reader);return (function (){var or__3128__auto__ = (cljs.reader.unread[goog.typeOf(x__3723__auto__)]);if(or__3128__auto__)
{return or__3128__auto__;
} else
{var or__3128__auto____$1 = (cljs.reader.unread["_"]);if(or__3128__auto____$1)
{return or__3128__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__3664__auto__,writer__3665__auto__,opt__3666__auto__){return cljs.core._write.call(null,writer__3665__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__3128__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__17012){
var rdr = cljs.core.first(arglist__17012);
var msg = cljs.core.rest(arglist__17012);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__3119__auto__ = !((ch === "#"));if(and__3119__auto__)
{var and__3119__auto____$1 = !((ch === "'"));if(and__3119__auto____$1)
{var and__3119__auto____$2 = !((ch === ":"));if(and__3119__auto____$2)
...
{{
var G__17013 = (function (){sb.append(ch);
return sb;
})();
var G__17014 = cljs.reader.read_char.call(null,rdr);
sb = G__17013;
ch = G__17014;
continue;
}
...
{{
var G__17015 = cljs.reader.read_char.call(null,rdr);
ch = G__17015;
continue;
}
} else
...
var G__17016 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__17016;
continue;
}
} else
...
var G__17017 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__17017;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__3128__auto__ = (ch == null);if(or__3128__auto__)
{return or__3128__auto__;
} else
{var or__3128__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__3128__auto____$1)
{return or__3128__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__3128__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
...
{{
var G__17018 = (function (){buffer.append(ch);
return buffer;
})();
var G__17019 = cljs.reader.read_char.call(null,reader);
buffer = G__17018;
ch = G__17019;
continue;
}
...
{if(("\\" === ch))
{{
var G__17020 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__17021 = cljs.reader.read_char.call(null,reader);
buffer = G__17020;
ch = G__17021;
continue;
}
...
{{
var G__17022 = (function (){buffer.append(ch);
return buffer;
})();
var G__17023 = cljs.reader.read_char.call(null,reader);
buffer = G__17022;
ch = G__17023;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__17025 = o;if(G__17025)
{var bit__3746__auto__ = (G__17025.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__3746__auto__) || (G__17025.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__17025.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__17025);
} else
{return false;
}
}
...
{{
var G__17026 = reader;
var G__17027 = eof_is_error;
var G__17028 = sentinel;
var G__17029 = is_recursive;
reader = G__17026;
eof_is_error = G__17027;
sentinel = G__17028;
is_recursive = G__17029;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__17030 = cljs.reader.read_comment.call(null,reader,ch);
var G__17031 = eof_is_error;
var G__17032 = sentinel;
var G__17033 = is_recursive;
reader = G__17030;
eof_is_error = G__17031;
sentinel = G__17032;
is_recursive = G__17033;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__17034 = reader;
var G__17035 = eof_is_error;
var G__17036 = sentinel;
var G__17037 = is_recursive;
reader = G__17034;
eof_is_error = G__17035;
sentinel = G__17036;
is_recursive = G__17037;
continue;
}
} else
{return res;
...
cljs.reader.leap_year_QMARK_ = (function leap_year_QMARK_(year){var and__3119__auto__ = cljs.reader.divisible_QMARK_.call(null,year,4);if(cljs.core.truth_(and__3119__auto__))
{var or__3128__auto__ = cljs.reader.indivisible_QMARK_.call(null,year,100);if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__17040 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__17040,0,null);var years = cljs.core.nth.call(null,vec__17040,1,null);var months = cljs.core.nth.call(null,vec__17040,2,null);var days = cljs.core.nth.call(null,vec__17040,3,null);var hours = cljs.core.nth.call(null,vec__17040,4,null);var minutes = cljs.core.nth.call(null,vec__17040,5,null);var seconds = cljs.core.nth.call(null,vec__17040,6,null);var fraction = cljs.core.nth.call(null,vec__17040,7,null);var offset_sign = cljs.core.nth.call(null,vec__17040,8,null);var offset_hours = cljs.core.nth.call(null,vec__17040,9,null);var offset_minutes = cljs.core.nth.call(null,vec__17040,10,null);var v = vec__17040;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__3128__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__3128__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__3128__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__3128__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__3128__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__3128__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__3128__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__3128__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__3128__auto__))
{return or__3128__auto__;
} else
{return 0;
}
...
{var vec__17042 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__17042,0,null);var months = cljs.core.nth.call(null,vec__17042,1,null);var days = cljs.core.nth.call(null,vec__17042,2,null);var hours = cljs.core.nth.call(null,vec__17042,3,null);var minutes = cljs.core.nth.call(null,vec__17042,4,null);var seconds = cljs.core.nth.call(null,vec__17042,5,null);var ms = cljs.core.nth.call(null,vec__17042,6,null);var offset = cljs.core.nth.call(null,vec__17042,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
