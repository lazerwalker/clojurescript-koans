...
{var e = e18015;throw (new Error([cljs.core.str("Failed to load runner: "),cljs.core.str(name)].join(''),e));
} else
...
{var e = e18017;throw (new Error([cljs.core.str("Failed to load reporter: "),cljs.core.str(name)].join(''),e));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e18017;
} else
...
*/
specljs.config.with_config = (function with_config(config,action){var _STAR_runner_STAR_18028 = specljs.config._STAR_runner_STAR_;var _STAR_reporters_STAR_18029 = specljs.config._STAR_reporters_STAR_;var _STAR_specs_STAR_18030 = specljs.config._STAR_specs_STAR_;var _STAR_color_QMARK__STAR_18031 = specljs.config._STAR_color_QMARK__STAR_;var _STAR_full_stack_trace_QMARK__STAR_18032 = specljs.config._STAR_full_stack_trace_QMARK__STAR_;var _STAR_tag_filter_STAR_18033 = specljs.config._STAR_tag_filter_STAR_;try{specljs.config._STAR_runner_STAR_ = (cljs.core.truth_(new cljs.core.Keyword(null,"runner","runner",4389065378).cljs$core$IFn$_invoke$arity$1(config))?(function (){cljs.core.println.call(null,"loading runner in config");
...
}finally {specljs.config._STAR_tag_filter_STAR_ = _STAR_tag_filter_STAR_18033;
