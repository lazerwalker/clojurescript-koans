...
var G__3246_3247 = cljs.core.seq.call(null,webrepl.dom.call(null,v));
while(true){
if(G__3246_3247)
...
webrepl.append_dom.call(null,log,cljs.core.PersistentVector.fromArray(["\uFDD0'div",cljs.core.ObjMap.fromObject(["\uFDD0'class"],{"\uFDD0'class":[cljs.core.str("cg "),cljs.core.str((cljs.core.truth_(cls)?[cljs.core.str(" "),cljs.core.str(cls)].join(''):null))].join('')}),line_3253], true));
{
...
return webrepl.repl_print.call(null,log,p1__3255_SHARP_,null);
});
cljs.core._STAR_rtn_STAR_ = (function (p1__3256_SHARP_){
return webrepl.repl_print.call(null,log,p1__3256_SHARP_,"rtn");
});
cljs.core._STAR_err_STAR_ = (function (p1__3257_SHARP_){
return webrepl.repl_print.call(null,log,p1__3257_SHARP_,"err");
});
