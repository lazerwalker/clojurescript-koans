...
reader_error.cljs$lang$applyTo = (function (arglist__16008){
var rdr = cljs.core.first(arglist__16008);
var msg = cljs.core.rest(arglist__16008);
...
{{
var G__16009 = (function (){sb.append(ch);
return sb;
})();
var G__16010 = cljs.reader.read_char.call(null,rdr);
sb = G__16009;
ch = G__16010;
continue;
}
...
var G__16012 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__16012;
continue;
}
} else
...
var G__16013 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__16013;
continue;
}
}
...
{{
var G__16014 = (function (){buffer.append(ch);
return buffer;
})();
var G__16015 = cljs.reader.read_char.call(null,reader);
buffer = G__16014;
ch = G__16015;
continue;
}
...
{if(("\\" === ch))
{{
var G__16016 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__16017 = cljs.reader.read_char.call(null,reader);
buffer = G__16016;
ch = G__16017;
continue;
}
...
{{
var G__16018 = (function (){buffer.append(ch);
return buffer;
})();
var G__16019 = cljs.reader.read_char.call(null,reader);
buffer = G__16018;
ch = G__16019;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__16021 = o;if(G__16021)
{var bit__3746__auto__ = (G__16021.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__3746__auto__) || (G__16021.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__16021.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__16021);
} else
{return false;
}
}
...
{{
var G__16022 = reader;
var G__16023 = eof_is_error;
var G__16024 = sentinel;
var G__16025 = is_recursive;
reader = G__16022;
eof_is_error = G__16023;
sentinel = G__16024;
is_recursive = G__16025;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__16026 = cljs.reader.read_comment.call(null,reader,ch);
var G__16027 = eof_is_error;
var G__16028 = sentinel;
var G__16029 = is_recursive;
reader = G__16026;
eof_is_error = G__16027;
sentinel = G__16028;
is_recursive = G__16029;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__16030 = reader;
var G__16031 = eof_is_error;
var G__16032 = sentinel;
var G__16033 = is_recursive;
reader = G__16030;
eof_is_error = G__16031;
sentinel = G__16032;
is_recursive = G__16033;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__16036 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__16036,0,null);var years = cljs.core.nth.call(null,vec__16036,1,null);var months = cljs.core.nth.call(null,vec__16036,2,null);var days = cljs.core.nth.call(null,vec__16036,3,null);var hours = cljs.core.nth.call(null,vec__16036,4,null);var minutes = cljs.core.nth.call(null,vec__16036,5,null);var seconds = cljs.core.nth.call(null,vec__16036,6,null);var fraction = cljs.core.nth.call(null,vec__16036,7,null);var offset_sign = cljs.core.nth.call(null,vec__16036,8,null);var offset_hours = cljs.core.nth.call(null,vec__16036,9,null);var offset_minutes = cljs.core.nth.call(null,vec__16036,10,null);var v = vec__16036;if(cljs.core.not.call(null,v))
...
{var vec__16038 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__16038,0,null);var months = cljs.core.nth.call(null,vec__16038,1,null);var days = cljs.core.nth.call(null,vec__16038,2,null);var hours = cljs.core.nth.call(null,vec__16038,3,null);var minutes = cljs.core.nth.call(null,vec__16038,4,null);var seconds = cljs.core.nth.call(null,vec__16038,5,null);var ms = cljs.core.nth.call(null,vec__16038,6,null);var offset = cljs.core.nth.call(null,vec__16038,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
