...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16039 = 0;while(true){
var m_16040 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16040 == null))
{} else
{m_16040.call(null);
if((count_16039 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16041 = (count_16039 + 1);
count_16039 = G__16041;
continue;
}
} else
{}
