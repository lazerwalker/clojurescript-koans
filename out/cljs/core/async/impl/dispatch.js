...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_28678 = 0;while(true){
var m_28679 = cljs.core.async.impl.dispatch.tasks.pop();if((m_28679 == null))
{} else
{m_28679.call(null);
if((count_28678 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__28680 = (count_28678 + 1);
count_28678 = G__28680;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3119__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3119__auto__)
