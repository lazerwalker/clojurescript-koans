...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_28540 = 0;while(true){
var m_28541 = cljs.core.async.impl.dispatch.tasks.pop();if((m_28541 == null))
{} else
{m_28541.call(null);
if((count_28540 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__28542 = (count_28540 + 1);
count_28540 = G__28542;
continue;
}
} else
{}
