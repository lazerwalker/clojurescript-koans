...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t28546 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t28546 = (function (val,box,meta28547){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t28546.cljs$lang$type = true;
cljs.core.async.impl.channels.t28546.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t28546";
cljs.core.async.impl.channels.t28546.cljs$lang$ctorPrWriter = (function (this__3664__auto__,writer__3665__auto__,opt__3666__auto__){return cljs.core._write.call(null,writer__3665__auto__,"cljs.core.async.impl.channels/t28546");
});
cljs.core.async.impl.channels.t28546.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t28546.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28548){var self__ = this;
var _28548__$1 = this;return self__.meta28547;
});
cljs.core.async.impl.channels.t28546.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28548,meta28547__$1){var self__ = this;
var _28548__$1 = this;return (new cljs.core.async.impl.channels.t28546(self__.val,self__.box,meta28547__$1));
});
cljs.core.async.impl.channels.__GT_t28546 = (function __GT_t28546(val__$1,box__$1,meta28547){return (new cljs.core.async.impl.channels.t28546(val__$1,box__$1,meta28547));
});
}
return (new cljs.core.async.impl.channels.t28546(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_28549 = self__.takes.pop();if((taker_28549 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_28549))
{var take_cb_28550 = cljs.core.async.impl.protocols.commit.call(null,taker_28549);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_28550,taker_28549){
return (function (){return take_cb_28550.call(null,null);
});})(take_cb_28550,taker_28549))
);
} else
{}
{
