...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3664__auto__,writer__3665__auto__,opt__3666__auto__){return cljs.core._write.call(null,writer__3665__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_28655 = 0;while(true){
if((i_28655 < arr.length))
{(arr[i_28655] = null);
{
var G__28656 = (i_28655 + 1);
i_28655 = G__28656;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3664__auto__,writer__3665__auto__,opt__3666__auto__){return cljs.core._write.call(null,writer__3665__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_28662 = (self__.level + 1);while(true){
if((i_28662 <= (new_level + 1)))
{(update[i_28662] = self__.header);
{
var G__28663 = (i_28662 + 1);
i_28662 = G__28663;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_28664 = 0;while(true){
if((i_28664 <= self__.level))
{var links_28665 = (update[i_28664]).forward;if(((links_28665[i_28664]) === x__$1))
{(links_28665[i_28664] = (x__$1.forward[i_28664]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3128__auto__ = (cljs.core.truth_((function (){var and__3119__auto__ = me;if(cljs.core.truth_(and__3119__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3119__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3128__auto__))
