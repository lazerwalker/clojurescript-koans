...
koans.meditations.Koan.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3684__auto__,k25358,else__3685__auto__){var self__ = this;
var this__3684__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k25358,new cljs.core.Keyword(null,"description","description",3584325486)))
{return self__.description;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k25358,new cljs.core.Keyword(null,"before","before",3915985649)))
{return self__.before;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k25358,new cljs.core.Keyword(null,"after","after",1106639182)))
{return self__.after;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k25358,else__3685__auto__);
} else
{return null;
}
}
...
koans.meditations.Koan.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3689__auto__,k__3690__auto__,G__25357){var self__ = this;
var this__3689__auto____$1 = this;var pred__25360 = cljs.core.keyword_identical_QMARK_;var expr__25361 = k__3690__auto__;if(pred__25360.call(null,new cljs.core.Keyword(null,"description","description",3584325486),expr__25361))
{return (new koans.meditations.Koan(G__25357,self__.before,self__.after,self__.__meta,self__.__extmap,null));
} else
{if(pred__25360.call(null,new cljs.core.Keyword(null,"before","before",3915985649),expr__25361))
{return (new koans.meditations.Koan(self__.description,G__25357,self__.after,self__.__meta,self__.__extmap,null));
} else
{if(pred__25360.call(null,new cljs.core.Keyword(null,"after","after",1106639182),expr__25361))
{return (new koans.meditations.Koan(self__.description,self__.before,G__25357,self__.__meta,self__.__extmap,null));
} else
{return (new koans.meditations.Koan(self__.description,self__.before,self__.after,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3690__auto__,G__25357),null));
}
}
}
});
...
koans.meditations.Koan.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3681__auto__,G__25357){var self__ = this;
var this__3681__auto____$1 = this;return (new koans.meditations.Koan(self__.description,self__.before,self__.after,G__25357,self__.__extmap,self__.__hash));
});
...
koans.meditations.map__GT_Koan = (function map__GT_Koan(G__25359){return (new koans.meditations.Koan(new cljs.core.Keyword(null,"description","description",3584325486).cljs$core$IFn$_invoke$arity$1(G__25359),new cljs.core.Keyword(null,"before","before",3915985649).cljs$core$IFn$_invoke$arity$1(G__25359),new cljs.core.Keyword(null,"after","after",1106639182).cljs$core$IFn$_invoke$arity$1(G__25359),null,cljs.core.dissoc.call(null,G__25359,new cljs.core.Keyword(null,"description","description",3584325486),new cljs.core.Keyword(null,"before","before",3915985649),new cljs.core.Keyword(null,"after","after",1106639182))));
});
...
koans.meditations.KoanIndex.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3684__auto__,k25364,else__3685__auto__){var self__ = this;
var this__3684__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k25364,new cljs.core.Keyword(null,"category","category",1064415344)))
{return self__.category;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k25364,new cljs.core.Keyword(null,"index","index",1114250308)))
{return self__.index;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k25364,else__3685__auto__);
} else
{return null;
}
}
...
koans.meditations.KoanIndex.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3689__auto__,k__3690__auto__,G__25363){var self__ = this;
var this__3689__auto____$1 = this;var pred__25366 = cljs.core.keyword_identical_QMARK_;var expr__25367 = k__3690__auto__;if(pred__25366.call(null,new cljs.core.Keyword(null,"category","category",1064415344),expr__25367))
{return (new koans.meditations.KoanIndex(G__25363,self__.index,self__.__meta,self__.__extmap,null));
} else
{if(pred__25366.call(null,new cljs.core.Keyword(null,"index","index",1114250308),expr__25367))
{return (new koans.meditations.KoanIndex(self__.category,G__25363,self__.__meta,self__.__extmap,null));
} else
{return (new koans.meditations.KoanIndex(self__.category,self__.index,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3690__auto__,G__25363),null));
}
}
});
...
koans.meditations.KoanIndex.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3681__auto__,G__25363){var self__ = this;
var this__3681__auto____$1 = this;return (new koans.meditations.KoanIndex(self__.category,self__.index,G__25363,self__.__extmap,self__.__hash));
});
...
koans.meditations.map__GT_KoanIndex = (function map__GT_KoanIndex(G__25365){return (new koans.meditations.KoanIndex(new cljs.core.Keyword(null,"category","category",1064415344).cljs$core$IFn$_invoke$arity$1(G__25365),new cljs.core.Keyword(null,"index","index",1114250308).cljs$core$IFn$_invoke$arity$1(G__25365),null,cljs.core.dissoc.call(null,G__25365,new cljs.core.Keyword(null,"category","category",1064415344),new cljs.core.Keyword(null,"index","index",1114250308))));
});
...
{return clojure.string.replace.call(null,cljs.core.pr_str.call(null,expr),/\(quote (.*?)\)/,(function (p1__25370_SHARP_,p2__25369_SHARP_){return [cljs.core.str("'"),cljs.core.str(p2__25369_SHARP_)].join('');
}));
}
});
...
{var _ = e25375;return cljs.core.first.call(null,category_list);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e25375;
} else
...
}})();var description = cljs.core.first.call(null,item);var full_text = koans.meditations.expr_to_string.call(null,cljs.core.last.call(null,item));var vec__25374 = clojure.string.split.call(null,full_text,/:__/);var before = cljs.core.nth.call(null,vec__25374,0,null);var after = cljs.core.nth.call(null,vec__25374,1,null);cljs.core.dorun.call(null,cljs.core.map.call(null,(function (p1__25371_SHARP_){return koans.repl.eval.call(null,cljs.core.pr_str.call(null,p1__25371_SHARP_));
