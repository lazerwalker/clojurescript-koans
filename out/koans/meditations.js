...
koans.meditations.Koan.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3684__auto__,k25489,else__3685__auto__){var self__ = this;
var this__3684__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k25489,new cljs.core.Keyword(null,"description","description",3584325486)))
{return self__.description;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k25489,new cljs.core.Keyword(null,"before","before",3915985649)))
{return self__.before;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k25489,new cljs.core.Keyword(null,"after","after",1106639182)))
{return self__.after;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k25489,else__3685__auto__);
} else
{return null;
}
}
...
koans.meditations.Koan.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3689__auto__,k__3690__auto__,G__25488){var self__ = this;
var this__3689__auto____$1 = this;var pred__25491 = cljs.core.keyword_identical_QMARK_;var expr__25492 = k__3690__auto__;if(pred__25491.call(null,new cljs.core.Keyword(null,"description","description",3584325486),expr__25492))
{return (new koans.meditations.Koan(G__25488,self__.before,self__.after,self__.__meta,self__.__extmap,null));
} else
{if(pred__25491.call(null,new cljs.core.Keyword(null,"before","before",3915985649),expr__25492))
{return (new koans.meditations.Koan(self__.description,G__25488,self__.after,self__.__meta,self__.__extmap,null));
} else
{if(pred__25491.call(null,new cljs.core.Keyword(null,"after","after",1106639182),expr__25492))
{return (new koans.meditations.Koan(self__.description,self__.before,G__25488,self__.__meta,self__.__extmap,null));
} else
{return (new koans.meditations.Koan(self__.description,self__.before,self__.after,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3690__auto__,G__25488),null));
}
}
}
});
...
koans.meditations.Koan.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3681__auto__,G__25488){var self__ = this;
var this__3681__auto____$1 = this;return (new koans.meditations.Koan(self__.description,self__.before,self__.after,G__25488,self__.__extmap,self__.__hash));
});
...
koans.meditations.map__GT_Koan = (function map__GT_Koan(G__25490){return (new koans.meditations.Koan(new cljs.core.Keyword(null,"description","description",3584325486).cljs$core$IFn$_invoke$arity$1(G__25490),new cljs.core.Keyword(null,"before","before",3915985649).cljs$core$IFn$_invoke$arity$1(G__25490),new cljs.core.Keyword(null,"after","after",1106639182).cljs$core$IFn$_invoke$arity$1(G__25490),null,cljs.core.dissoc.call(null,G__25490,new cljs.core.Keyword(null,"description","description",3584325486),new cljs.core.Keyword(null,"before","before",3915985649),new cljs.core.Keyword(null,"after","after",1106639182))));
});
...
koans.meditations.KoanIndex.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3684__auto__,k25495,else__3685__auto__){var self__ = this;
var this__3684__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k25495,new cljs.core.Keyword(null,"category","category",1064415344)))
{return self__.category;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k25495,new cljs.core.Keyword(null,"index","index",1114250308)))
{return self__.index;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k25495,else__3685__auto__);
} else
{return null;
}
}
...
koans.meditations.KoanIndex.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3689__auto__,k__3690__auto__,G__25494){var self__ = this;
var this__3689__auto____$1 = this;var pred__25497 = cljs.core.keyword_identical_QMARK_;var expr__25498 = k__3690__auto__;if(pred__25497.call(null,new cljs.core.Keyword(null,"category","category",1064415344),expr__25498))
{return (new koans.meditations.KoanIndex(G__25494,self__.index,self__.__meta,self__.__extmap,null));
} else
{if(pred__25497.call(null,new cljs.core.Keyword(null,"index","index",1114250308),expr__25498))
{return (new koans.meditations.KoanIndex(self__.category,G__25494,self__.__meta,self__.__extmap,null));
} else
{return (new koans.meditations.KoanIndex(self__.category,self__.index,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3690__auto__,G__25494),null));
}
}
});
...
koans.meditations.KoanIndex.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3681__auto__,G__25494){var self__ = this;
var this__3681__auto____$1 = this;return (new koans.meditations.KoanIndex(self__.category,self__.index,G__25494,self__.__extmap,self__.__hash));
});
...
koans.meditations.map__GT_KoanIndex = (function map__GT_KoanIndex(G__25496){return (new koans.meditations.KoanIndex(new cljs.core.Keyword(null,"category","category",1064415344).cljs$core$IFn$_invoke$arity$1(G__25496),new cljs.core.Keyword(null,"index","index",1114250308).cljs$core$IFn$_invoke$arity$1(G__25496),null,cljs.core.dissoc.call(null,G__25496,new cljs.core.Keyword(null,"category","category",1064415344),new cljs.core.Keyword(null,"index","index",1114250308))));
});
...
koans.meditations.Category.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3684__auto__,k25501,else__3685__auto__){var self__ = this;
var this__3684__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k25501,new cljs.core.Keyword(null,"name","name",1017277949)))
{return self__.name;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k25501,new cljs.core.Keyword(null,"koans","koans",1116124532)))
{return self__.koans;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k25501,new cljs.core.Keyword(null,"fns","fns",1014005789)))
{return self__.fns;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k25501,else__3685__auto__);
} else
{return null;
}
}
...
koans.meditations.Category.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3689__auto__,k__3690__auto__,G__25500){var self__ = this;
var this__3689__auto____$1 = this;var pred__25503 = cljs.core.keyword_identical_QMARK_;var expr__25504 = k__3690__auto__;if(pred__25503.call(null,new cljs.core.Keyword(null,"name","name",1017277949),expr__25504))
{return (new koans.meditations.Category(G__25500,self__.koans,self__.fns,self__.__meta,self__.__extmap,null));
} else
{if(pred__25503.call(null,new cljs.core.Keyword(null,"koans","koans",1116124532),expr__25504))
{return (new koans.meditations.Category(self__.name,G__25500,self__.fns,self__.__meta,self__.__extmap,null));
} else
{if(pred__25503.call(null,new cljs.core.Keyword(null,"fns","fns",1014005789),expr__25504))
{return (new koans.meditations.Category(self__.name,self__.koans,G__25500,self__.__meta,self__.__extmap,null));
} else
{return (new koans.meditations.Category(self__.name,self__.koans,self__.fns,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3690__auto__,G__25500),null));
}
}
}
});
...
koans.meditations.Category.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3681__auto__,G__25500){var self__ = this;
var this__3681__auto____$1 = this;return (new koans.meditations.Category(self__.name,self__.koans,self__.fns,G__25500,self__.__extmap,self__.__hash));
});
...
koans.meditations.map__GT_Category = (function map__GT_Category(G__25502){return (new koans.meditations.Category(new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(G__25502),new cljs.core.Keyword(null,"koans","koans",1116124532).cljs$core$IFn$_invoke$arity$1(G__25502),new cljs.core.Keyword(null,"fns","fns",1014005789).cljs$core$IFn$_invoke$arity$1(G__25502),null,cljs.core.dissoc.call(null,G__25502,new cljs.core.Keyword(null,"name","name",1017277949),new cljs.core.Keyword(null,"koans","koans",1116124532),new cljs.core.Keyword(null,"fns","fns",1014005789))));
});
...
{return clojure.string.replace.call(null,cljs.core.pr_str.call(null,expr),/\(quote (.*?)\)/,(function (p1__25508_SHARP_,p2__25507_SHARP_){return [cljs.core.str("'"),cljs.core.str(p2__25507_SHARP_)].join('');
}));
}
});
...
{var _ = e25513;return cljs.core.first.call(null,category_list);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e25513;
} else
...
}})();var description = cljs.core.first.call(null,item);var full_text = koans.meditations.expr_to_string.call(null,cljs.core.last.call(null,item));var vec__25512 = clojure.string.split.call(null,full_text,/:__/);var before = cljs.core.nth.call(null,vec__25512,0,null);var after = cljs.core.nth.call(null,vec__25512,1,null);cljs.core.dorun.call(null,cljs.core.map.call(null,(function (p1__25509_SHARP_){return koans.repl.eval.call(null,cljs.core.pr_str.call(null,p1__25509_SHARP_));
