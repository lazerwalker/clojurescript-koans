...
* @param {*=} __extmap
*/
koans.meditations.Koan = (function (description,code_strings,fn_strings,__meta,__extmap){
...
koans.meditations.Koan.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3684__auto__,k12813,else__3685__auto__){var self__ = this;
var this__3684__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k12813,new cljs.core.Keyword(null,"description","description",3584325486)))
{return self__.description;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k12813,new cljs.core.Keyword(null,"code-strings","code-strings",2204559892)))
{return self__.code_strings;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k12813,new cljs.core.Keyword(null,"fn-strings","fn-strings",4723129839)))
{return self__.fn_strings;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k12813,else__3685__auto__);
} else
{return null;
}
}
...
koans.meditations.Koan.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3689__auto__,k__3690__auto__,G__12812){var self__ = this;
var this__3689__auto____$1 = this;var pred__12815 = cljs.core.keyword_identical_QMARK_;var expr__12816 = k__3690__auto__;if(pred__12815.call(null,new cljs.core.Keyword(null,"description","description",3584325486),expr__12816))
{return (new koans.meditations.Koan(G__12812,self__.code_strings,self__.fn_strings,self__.__meta,self__.__extmap,null));
} else
{if(pred__12815.call(null,new cljs.core.Keyword(null,"code-strings","code-strings",2204559892),expr__12816))
{return (new koans.meditations.Koan(self__.description,G__12812,self__.fn_strings,self__.__meta,self__.__extmap,null));
} else
{if(pred__12815.call(null,new cljs.core.Keyword(null,"fn-strings","fn-strings",4723129839),expr__12816))
{return (new koans.meditations.Koan(self__.description,self__.code_strings,G__12812,self__.__meta,self__.__extmap,null));
} else
{return (new koans.meditations.Koan(self__.description,self__.code_strings,self__.fn_strings,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3690__auto__,G__12812),null));
}
}
}
});
...
});return cljs.core.pr_sequential_writer.call(null,writer__3697__auto__,pr_pair__3699__auto__,"#koans.meditations.Koan{",", ","}",opts__3698__auto__,cljs.core.concat.call(null,cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null,new cljs.core.Keyword(null,"description","description",3584325486),self__.description),cljs.core.vector.call(null,new cljs.core.Keyword(null,"code-strings","code-strings",2204559892),self__.code_strings),cljs.core.vector.call(null,new cljs.core.Keyword(null,"fn-strings","fn-strings",4723129839),self__.fn_strings)], true),self__.__extmap));
});
...
koans.meditations.Koan.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3681__auto__,G__12812){var self__ = this;
var this__3681__auto____$1 = this;return (new koans.meditations.Koan(self__.description,self__.code_strings,self__.fn_strings,G__12812,self__.__extmap,self__.__hash));
});
...
var this__3691__auto____$1 = this;if(cljs.core.contains_QMARK_.call(null,cljs.core.PersistentHashSet.fromArray([new cljs.core.Keyword(null,"code-strings","code-strings",2204559892),null,new cljs.core.Keyword(null,"description","description",3584325486),null,new cljs.core.Keyword(null,"fn-strings","fn-strings",4723129839),null], true),k__3692__auto__))
...
{return (new koans.meditations.Koan(self__.description,self__.code_strings,self__.fn_strings,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__3692__auto__)),null));
}
});
...
koans.meditations.map__GT_Koan = (function map__GT_Koan(G__12814){return (new koans.meditations.Koan(new cljs.core.Keyword(null,"description","description",3584325486).cljs$core$IFn$_invoke$arity$1(G__12814),new cljs.core.Keyword(null,"code-strings","code-strings",2204559892).cljs$core$IFn$_invoke$arity$1(G__12814),new cljs.core.Keyword(null,"fn-strings","fn-strings",4723129839).cljs$core$IFn$_invoke$arity$1(G__12814),null,cljs.core.dissoc.call(null,G__12814,new cljs.core.Keyword(null,"description","description",3584325486),new cljs.core.Keyword(null,"code-strings","code-strings",2204559892),new cljs.core.Keyword(null,"fn-strings","fn-strings",4723129839))));
});
...
koans.meditations.KoanIndex.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3684__auto__,k12819,else__3685__auto__){var self__ = this;
var this__3684__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k12819,new cljs.core.Keyword(null,"category","category",1064415344)))
{return self__.category;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k12819,new cljs.core.Keyword(null,"index","index",1114250308)))
{return self__.index;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k12819,else__3685__auto__);
} else
{return null;
}
}
...
koans.meditations.KoanIndex.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3689__auto__,k__3690__auto__,G__12818){var self__ = this;
var this__3689__auto____$1 = this;var pred__12821 = cljs.core.keyword_identical_QMARK_;var expr__12822 = k__3690__auto__;if(pred__12821.call(null,new cljs.core.Keyword(null,"category","category",1064415344),expr__12822))
{return (new koans.meditations.KoanIndex(G__12818,self__.index,self__.__meta,self__.__extmap,null));
} else
{if(pred__12821.call(null,new cljs.core.Keyword(null,"index","index",1114250308),expr__12822))
{return (new koans.meditations.KoanIndex(self__.category,G__12818,self__.__meta,self__.__extmap,null));
} else
{return (new koans.meditations.KoanIndex(self__.category,self__.index,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3690__auto__,G__12818),null));
}
}
});
...
koans.meditations.KoanIndex.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3681__auto__,G__12818){var self__ = this;
var this__3681__auto____$1 = this;return (new koans.meditations.KoanIndex(self__.category,self__.index,G__12818,self__.__extmap,self__.__hash));
});
...
koans.meditations.map__GT_KoanIndex = (function map__GT_KoanIndex(G__12820){return (new koans.meditations.KoanIndex(new cljs.core.Keyword(null,"category","category",1064415344).cljs$core$IFn$_invoke$arity$1(G__12820),new cljs.core.Keyword(null,"index","index",1114250308).cljs$core$IFn$_invoke$arity$1(G__12820),null,cljs.core.dissoc.call(null,G__12820,new cljs.core.Keyword(null,"category","category",1064415344),new cljs.core.Keyword(null,"index","index",1114250308))));
});
...
koans.meditations.Category.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__3684__auto__,k12825,else__3685__auto__){var self__ = this;
var this__3684__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k12825,new cljs.core.Keyword(null,"name","name",1017277949)))
{return self__.name;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k12825,new cljs.core.Keyword(null,"koans","koans",1116124532)))
{return self__.koans;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k12825,new cljs.core.Keyword(null,"fns","fns",1014005789)))
{return self__.fns;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k12825,else__3685__auto__);
} else
{return null;
}
}
...
koans.meditations.Category.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__3689__auto__,k__3690__auto__,G__12824){var self__ = this;
var this__3689__auto____$1 = this;var pred__12827 = cljs.core.keyword_identical_QMARK_;var expr__12828 = k__3690__auto__;if(pred__12827.call(null,new cljs.core.Keyword(null,"name","name",1017277949),expr__12828))
{return (new koans.meditations.Category(G__12824,self__.koans,self__.fns,self__.__meta,self__.__extmap,null));
} else
{if(pred__12827.call(null,new cljs.core.Keyword(null,"koans","koans",1116124532),expr__12828))
{return (new koans.meditations.Category(self__.name,G__12824,self__.fns,self__.__meta,self__.__extmap,null));
} else
{if(pred__12827.call(null,new cljs.core.Keyword(null,"fns","fns",1014005789),expr__12828))
{return (new koans.meditations.Category(self__.name,self__.koans,G__12824,self__.__meta,self__.__extmap,null));
} else
{return (new koans.meditations.Category(self__.name,self__.koans,self__.fns,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__3690__auto__,G__12824),null));
}
}
}
});
...
koans.meditations.Category.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__3681__auto__,G__12824){var self__ = this;
var this__3681__auto____$1 = this;return (new koans.meditations.Category(self__.name,self__.koans,self__.fns,G__12824,self__.__extmap,self__.__hash));
});
...
koans.meditations.map__GT_Category = (function map__GT_Category(G__12826){return (new koans.meditations.Category(new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(G__12826),new cljs.core.Keyword(null,"koans","koans",1116124532).cljs$core$IFn$_invoke$arity$1(G__12826),new cljs.core.Keyword(null,"fns","fns",1014005789).cljs$core$IFn$_invoke$arity$1(G__12826),null,cljs.core.dissoc.call(null,G__12826,new cljs.core.Keyword(null,"name","name",1017277949),new cljs.core.Keyword(null,"koans","koans",1116124532),new cljs.core.Keyword(null,"fns","fns",1014005789))));
});
...
koans.meditations.category_from_koan_index = (function category_from_koan_index(koan_index){return cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__12830_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(p1__12830_SHARP_),new cljs.core.Keyword(null,"category","category",1064415344).cljs$core$IFn$_invoke$arity$1(koan_index));
...
{return clojure.string.replace.call(null,cljs.core.pr_str.call(null,expr),/\(quote (.*?)\)/,(function (p1__12832_SHARP_,p2__12831_SHARP_){return [cljs.core.str("'"),cljs.core.str(p2__12831_SHARP_)].join('');
}));
}
});
...
{return cljs.core.PersistentVector.fromArray([text,new cljs.core.Keyword(null,"input","input",1114262332)], true);
}
...
{var _ = e12835;return cljs.core.first.call(null,category_list);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e12835;
} else
...
return (function (p1__12833_SHARP_){return koans.meditations.expr_to_array.call(null,p1__12833_SHARP_);
