...
koans.repl.derp = (function derp(){
return console.log("HI MOM");
});
goog.exportSymbol('koans.repl.derp', koans.repl.derp);
koans.repl.dom = (function dom(o){
...
{}
return cljs.core.PersistentVector.fromArray([koans.repl.append_dom.call(null,elem,((cljs.core.map_QMARK_.call(null,attrs))?body:cljs.core.cons.call(null,attrs,body)))], true);
} else
...
koans.repl.append_dom = (function append_dom(parent,v){
var G__3246_3247 = cljs.core.seq.call(null,koans.repl.dom.call(null,v));
while(true){
if(G__3246_3247)
...
koans.repl.repl_print = (function repl_print(log,text,cls){
...
koans.repl.append_dom.call(null,log,cljs.core.PersistentVector.fromArray(["\uFDD0'div",cljs.core.ObjMap.fromObject(["\uFDD0'class"],{"\uFDD0'class":[cljs.core.str("cg "),cljs.core.str((cljs.core.truth_(cls)?[cljs.core.str(" "),cljs.core.str(cls)].join(''):null))].join('')}),line_3253], true));
{
...
return koans.repl.repl_print.call(null,log,p1__3255_SHARP_,null);
});
cljs.core._STAR_rtn_STAR_ = (function (p1__3256_SHARP_){
return koans.repl.repl_print.call(null,log,p1__3256_SHARP_,"rtn");
});
cljs.core._STAR_err_STAR_ = (function (p1__3257_SHARP_){
return koans.repl.repl_print.call(null,log,p1__3257_SHARP_,"err");
});
...
koans.repl.append_dom.call(null,log,cljs.core.PersistentVector.fromArray(["\uFDD0'div",cljs.core.ObjMap.fromObject(["\uFDD0'class"],{"\uFDD0'class":"cg"}),";;   - ",cljs.core.PersistentVector.fromArray(["\uFDD0'a",cljs.core.ObjMap.fromObject(["\uFDD0'href"],{"\uFDD0'href":"http://github.com/kanaka/clojurescript"}),"http://github.com/kanaka/clojurescript"], true)], true));
cljs.core.println.call(null,";;   - A port of the ClojureScript compiler to ClojureScript");
koans.repl.pep.call(null,log,"(+ 1 2)");
koans.repl.pep.call(null,log,"(defn sqr [x] (* x x))");
koans.repl.pep.call(null,log,"(sqr 8)");
koans.repl.pep.call(null,log,"(defmacro unless [pred a b] `(if (not ~pred) ~a ~b))");
koans.repl.pep.call(null,log,"(unless false :yep :nope)");
input.onkeypress = (function (ev){
if(((function (){var or__3943__auto__ = ev;
if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
{return koans.repl.event;
}
})().keyCode === 13))
{var line = input.value;
if(cljs.core.truth_(cljs.repl.complete_form_QMARK_.call(null,line)))
{koans.repl.pep.call(null,log,line);
setTimeout((function (){
return input.value = "";
}),0);
