...
{{
var G__6115 = cljs.core.pop.call(null,v__$1);
v__$1 = G__6115;
continue;
}
} else
...
{var pred__6119 = cljs.core._EQ_;var expr__6120 = limit;if(pred__6119.call(null,1,expr__6120))
{return cljs.core.vector.call(null,s);
} else
{if(pred__6119.call(null,2,expr__6120))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__6122 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__6123 = (limit__$1 - 1);
var G__6124 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__6122;
limit__$1 = G__6123;
parts = G__6124;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___6126 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___6126))
{var replacement_6127 = temp__4090__auto___6126;buffer.append([cljs.core.str(replacement_6127)].join(''));
} else
{buffer.append(ch);
}
{
