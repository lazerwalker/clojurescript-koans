...
{{
var G__28982 = cljs.core.pop.call(null,v__$1);
v__$1 = G__28982;
continue;
}
} else
...
{var pred__28986 = cljs.core._EQ_;var expr__28987 = limit;if(pred__28986.call(null,1,expr__28987))
{return cljs.core.vector.call(null,s);
} else
{if(pred__28986.call(null,2,expr__28987))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__28989 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__28990 = (limit__$1 - 1);
var G__28991 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__28989;
limit__$1 = G__28990;
parts = G__28991;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___28993 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___28993))
{var replacement_28994 = temp__4090__auto___28993;buffer.append([cljs.core.str(replacement_28994)].join(''));
} else
{buffer.append(ch);
}
{
var G__28995 = (index + 1);
index = G__28995;
continue;
}
}
