...
var ns = (((replcljs.core.count.call(null,parts) > 1))?clojure.string.join.call(null,"/",replcljs.core.butlast.call(null,parts)):null);
var issue = (((replcljs.core.last.call(null,ns) === ":"))?"namespace can't ends with \":\"":(((replcljs.core.last.call(null,name) === ":"))?"name can't end with \":\"":(((replcljs.core.last.call(null,name) === "/"))?"name can't end with \"/\"":(((replcljs.core.count.call(null,clojure.string.split.call(null,token,/::/)) > 1))?"name can't contain \"::\"":null))));
