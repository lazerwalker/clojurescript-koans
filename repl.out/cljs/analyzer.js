...
return [replcljs.core.str(clojure.string.replace.call(null,replcljs.analyzer.munge_path.call(null,s),".","/")),replcljs.core.str(".cljs")].join('');
});
...
var ctor_sym = replcljs.core.symbol.call(null,replcljs.core.last.call(null,clojure.string.split.call(null,[replcljs.core.str(spec)].join(''),/\./)));
