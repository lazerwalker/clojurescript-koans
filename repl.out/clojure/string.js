replgoog.provide('clojure.string');
...
{return [replcljs.core.str(clojure.string.upper_case.call(null,replcljs.core.subs.call(null,s,0,1))),replcljs.core.str(clojure.string.lower_case.call(null,replcljs.core.subs.call(null,s,1)))].join('');
}
});
/**
...
replcljs.core.swap_BANG_.call(null,replcljs.core.namespaces,replcljs.core.update_in,replcljs.core.PersistentVector.fromArray([(new replcljs.core.Symbol(null,"clojure.string"))], true),(function (old){
